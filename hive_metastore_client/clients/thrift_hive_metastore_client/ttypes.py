            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i604 in range(_size600):
                        _key605 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val606 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.SET:
                    ...
                    for _i743 in range(_size739):
                        _elem744 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
